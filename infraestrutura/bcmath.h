...
public:
    ...
    QBCMath(qint32 num) : value(QString::number(num, 'f', 0)) {  }
    QBCMath(qint64 num) : value(QString::number(num, 'f', 0)) {  }
    QBCMath(quint32 num) : value(QString::number(num, 'f', 0)) {  }
    QBCMath(quint64 num) : value(QString::number(num, 'f', 0)) {  }
    QBCMath(float num) : value(QString::number((double)num, 'f')) {  }
